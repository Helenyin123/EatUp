...
public class YelpAPI {
	...
	private static final String CLIENT_ID = "eGprAsNMzCVjrFiuEZne0w";
	private static final String CLIENT_SECRET = "WEBCswhDDGrODe3FsDekCAHaRD1ebQJodJhteJ8oQJ8HufaLLlkwJ3kBOGTrRyk3";
	private static final String GRANT_TYPE = "client_credentials";
	private static final String TOKEN_TYPE = "Bearer";
	
	public YelpAPI() {}
	/**
	 * Create and sent a request to Yelp Token Host and return the access token
	 */
	...
	/**
	 * Queries the Search API based on the command line arguments and take the 
